...
# Load images
command "Step 2: Load images." "python ${TOOLHOME}/main.py load images --directory ${PROJECTHOME}/examples/qtype1/dicom --extension .dicom --qtype 1 --metadata-file images.json"
